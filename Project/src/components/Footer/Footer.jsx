...
// function Footer() {
//   return (
//     <div className="relative overflow-hidden py-10 bg-gray-400 border-t-2 border-t-black">
//       <div className="relative z-10 mx-auto max-w-7xl px-4">
//         <div className="-m-6 flex flex-wrap">
//           <div className="w-full p-6 md:w-1/2 lg:w-5/12">
//             <div className="flex h-full flex-col justify-between">
...
function Footer() {
  return (
    <div>Footer that is not allowing the main footer to render don't know why.....</div>
  )
}
